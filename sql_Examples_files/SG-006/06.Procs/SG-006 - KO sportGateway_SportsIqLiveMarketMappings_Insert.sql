/*
Failure
a GO statement is present between GRANT
*/
...
/*
Title : Offer.SG-026 - OK sportGateway_SportsIqLiveMarketMappings_Insert
Description:
...
*/
CREATE OR ALTER PROCEDURE [Offer].[sportGateway_SportsIqLiveMarketMappings_Insert]
(	
...
END
GO
GRANT EXECUTE ON [Offer].[sportGateway_SportsIqLiveMarketMappings_Insert] TO [Db_Offer];
GO
GRANT EXECUTE ON [Offer].[sportGateway_SportsIqLiveMarketMappings_Insert] TO [Db_Backoffice];
GO
