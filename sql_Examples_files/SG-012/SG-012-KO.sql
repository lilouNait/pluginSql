...
/*
Title : Offer.SG-012 - KO sportGateway_SportsIqLiveMarketMappings_Insert
Description:
...
IF NOT EXISTS (SELECT objtype, objname, name, value FROM fn_listextendedproperty('mdmOwner', 'SCHEMA', 'Offer', 'PROCEDURE', 'SG-012 - KO sportGateway_SportsIqLiveMarketMappings_Insert', null, null))
BEGIN
EXEC sp_addextendedproperty
    @name = N'mdmOwner',@value = N'Betting',@level0type = N'SCHEMA',@level0name = 'Offer',@level1type = N'PROCEDURE',@level1name = 'SG-012 - KO sportGateway_SportsIqLiveMarketMappings_Insert'
END
GO

GRANT EXECUTE ON [Offer].[SG-012 - KO sportGateway_SportsIqLiveMarketMappings_Insert] TO [Db_Offer];
GO
