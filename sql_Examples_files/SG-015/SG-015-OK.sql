...
CREATE
OR ALTER PROCEDURE
[Offer].[SG-015 - OK sportGateway_SportsIqLiveMarketMappings_Insert]
(
...
GRANT EXECUTE ON [Offer].[SG-015 - OK sportGateway_SportsIqLiveMarketMappings_Insert] TO [Db_Offer];
GO
