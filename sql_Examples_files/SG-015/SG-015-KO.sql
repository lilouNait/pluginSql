/*
Failure : wrong statements

Expeting :

CREATE OR ALTER PROCEDURE [Offer].[SG-015 - KO sportGateway_SportsIqLiveMarketMappings_Insert]
...
/*
Title : Offer.SG-015 - KO sportGateway_SportsIqLiveMarketMappings_Insert
Description:
...
*/
CREATE
[Offer].[SG-015 - KO sportGateway_SportsIqLiveMarketMappings_Insert]
(
...
IF NOT EXISTS (SELECT objtype, objname, name, value FROM fn_listextendedproperty('mdmOwner', 'SCHEMA', 'Offer', 'PROCEDURE', 'SG-015 - KO sportGateway_SportsIqLiveMarketMappings_Insert', null, null))
BEGIN
EXEC sp_addextendedproperty
    @name = N'mdmOwner',@value = N'Betting',@level0type = N'SCHEMA',@level0name = 'Offer',@level1type = N'PROCEDURE',@level1name = 'SG-015 - KO sportGateway_SportsIqLiveMarketMappings_Insert'
END
GO

GRANT EXECUTE ON [Offer].[SG-015 - KO sportGateway_SportsIqLiveMarketMappings_Insert] TO [Db_Offer];
GO
